...
```lua
window.getByCharacterId(characterId)
```
...
| ----------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <ul><li>characterId</li></ul> | <ul><li>int</li></ul> | <ul><li>Pour récupérer l'identifiant d'une fenêtre du jeu avec l'identifiant du personnage connecté sur cette fenêtre, à récupérer avec <a href="../character/id">cette méthode</a>.</li></ul> |
