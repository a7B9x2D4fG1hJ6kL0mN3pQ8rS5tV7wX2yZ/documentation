...
```lua
map.door(cellId, changeMap, timeout)
```
...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <ul><li>cellId</li></ul>    | <ul><li>int</li></ul>                                                                                                               | <ul><li>La cellule de l'interactif, à récupérer avec <a href="../../outils-pour-les-scripts/elements-de-la-carte">cet outil</a>.</li></ul>                                                                               |
